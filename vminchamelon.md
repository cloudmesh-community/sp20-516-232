...
```
(ENV3) ashok@Ashoks-MacBook-Pro ~ % cms vm terminate asingam-vm-10
Cloudmesh Database Update |################################| 1/1
+---------------+-----------+--------+---------+------+----------------+-----------+---------------+-------------+---------------+--------------+
| Name          | Cloud     | State  | Status  | Task | Image          | Flavor    | Public IPs    | Private IPs | Creation time | Started at   |
+---------------+-----------+--------+---------+------+----------------+-----------+---------------+-------------+---------------+--------------+
| asingam-vm-10 | chameleon | active | DELETED |      | CC-Ubuntu18.04 | m1.medium | 129.114.26.87 |             | 26.00         | 22 hours ago |
+---------------+-----------+--------+---------+------+----------------+-----------+---------------+-------------+---------------+--------------+
Timer: 5.0000s (vm terminate asingam-vm-10)
```
